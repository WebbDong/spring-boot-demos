package com.webbdong.springboot.aop.ctw.aspect;
...
public class AspectDemo {
     ...
     */
    @Pointcut("execution(public * com.webbdong.springboot.aop.ctw.service.AspectDemoService.*(..))")
     ...
     * 前置通知
     */
    // 使用 aspectj 实现的 CTW，before 通知不可以使用，
